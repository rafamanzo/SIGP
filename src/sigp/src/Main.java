...
//			session.save(student2);
			...
			Publicacao student1 = new Publicacao("O homem 2", Veiculo.JOURNAL, "Bezerra da Silva", data, grupo);
			Publicacao student2 = new Publicacao("O homem", Veiculo.CONFERENCIA, "Bezerra da Silva", data, grupo);
			session.save(student1);
			session.save(student2);
